...
## Files in This Project Repo

| File | What it is |
|------|-----------|
| `PROJECT_BRIEF.md` | Full design brief from LLM Council analysis. Read this for deep context on every subsystem. |
| `council-report-20260605.html` | HTML report from the council run on sequencing. Open in a browser. |
| `terminal-phase-sim-guide.md` | **Start here for active work.** Step-by-step guide to writing and running the terminal phase simulation in Python — full script, all design decisions, latency budget, sensitivity analysis, research checklist. |
| `CLAUDE.md` | This file. Auto-loaded by Claude when this folder is connected. |
